...
def validate_username_available(username: str, exclude_user_id=None):
...
def clean_and_validate_username(username: str, exclude_user_id=None):
    clean_username = username.strip().lstrip("@")

    validate_username_format(clean_username)
    validate_username_available(clean_username, exclude_user_id)
