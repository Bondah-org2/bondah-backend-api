...
class LivenessVerificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Actions", {"fields": ("actions_required", "actions_completed")}),
        ("Timestamps", {"fields": ("started_at", "completed_at", "expires_at")}),
        (
            "Technical Details",
            {
                "fields": (
...
class EmailVerificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Verification Info", {"fields": ("user", "email", "otp_code")}),
        ("Status", {"fields": ("is_verified", "is_used")}),
...
class MessageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Message Info", {"fields": ("chat", "sender", "message_type", "content")}),
        (
            "Media Attachments",
            {
                "fields": (
        ...
        ("Status", {"fields": ("is_read", "read_at", "is_edited", "edited_at")}),
        ("Reply", {"fields": ("reply_to",)}),
        ("Reactions", {"fields": ("reactions",), "classes": ("collapse",)}),
...
class VoiceNoteAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Transcription", {"fields": ("transcription", "transcription_confidence")}),
...
class CallAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Call Info", {"fields": ("chat", "caller", "callee", "call_type", "status")}),
        ("Call Details", {"fields": ("call_id", "room_id", "quality_score")}),
        (
            "Timing",
            {
                "fields": (
        ...
        (
            "Recording",
            {"fields": ("is_recorded", "recording_url"), "classes": ("collapse",)},
        ),
    )
...
class ChatParticipantAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Participant Info", {"fields": ("chat", "user", "is_active")}),
        (
            "Settings",
            {"fields": ("notifications_enabled", "mute_until", "custom_nickname")},
        ),
        ("Activity", {"fields": ("last_seen_at", "last_read_message")}),
...
class ChatReportAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Report Info", {"fields": ("reporter", "reported_user", "chat", "message")}),
        ("Report Details", {"fields": ("report_type", "description", "status")}),
        (
            "Moderation",
            {
                "fields": (
...
class PostAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Metadata", {"fields": ("hashtags", "mentions"), "classes": ("collapse",)}),
        (
            "Engagement",
            {
                "fields": (
        ...
        ("Status", {"fields": ("is_active", "is_featured", "is_reported")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class PostCommentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Comment Info", {"fields": ("post", "author", "content", "parent_comment")}),
        ("Engagement", {"fields": ("likes_count", "replies_count")}),
        ("Status", {"fields": ("is_active", "is_edited")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class PostReportAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Report Info", {"fields": ("reporter", "reported_user", "post", "comment")}),
        ("Report Details", {"fields": ("report_type", "description", "status")}),
        (
            "Moderation",
            {
...
class StoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Story Info", {"fields": ("author", "story_type", "content")}),
        (
            "Media",
            {
        ...
        ("Engagement", {"fields": ("views_count", "reactions_count")}),
...
class FeedSearchAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Search Info", {"fields": ("user", "query", "results_count")}),
        ("Filters", {"fields": ("filters_applied",), "classes": ("collapse",)}),
        ("Timestamps", {"fields": ("created_at",)}),
    )
...
class LiveSessionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Session Info", {"fields": ("user", "title", "description", "status")}),
        ("Timing", {"fields": ("start_time", "end_time", "duration_limit_minutes")}),
        ("Metrics", {"fields": ("viewers_count", "likes_count")}),
        (
            "Stream Details",
            {"fields": ("stream_url", "thumbnail_url"), "classes": ("collapse",)},
        ),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class LiveParticipantAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Participation Info", {"fields": ("session", "user", "role")}),
...
class UserSocialHandleAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Social Handle Info", {"fields": ("user", "platform", "handle", "url")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class DocumentVerificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Verification Info", {"fields": ("user", "document_type", "status")}),
        ("Document Images", {"fields": ("front_image_url", "back_image_url")}),
...
class UserSubscriptionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Payment", {"fields": ("payment_method", "transaction_id", "auto_renew")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class BondcoinPackageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Package Info", {"fields": ("name", "bondcoin_amount", "price_usd")}),
        ("Status", {"fields": ("is_popular", "is_active")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class VirtualGiftAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Gift Info", {"fields": ("name", "category", "description", "icon_url")}),
        ("Pricing", {"fields": ("cost_bondcoins",)}),
        ("Status", {"fields": ("is_popular", "is_active")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class GiftTransactionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Context", {"fields": ("context_type", "context_id", "message")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class LiveJoinRequestAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Response", {"fields": ("responded_by", "response_message", "responded_at")}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
...
class PaymentTransactionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Related Objects", {"fields": ("subscription", "bondcoin_transaction")}),
...
>>>>>>> 142727b9 (Clean repo and fix gitignore)
